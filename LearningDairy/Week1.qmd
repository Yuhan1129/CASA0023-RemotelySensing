...
-   Spectral Resolution: The number of bands it records data in.
    ...
    -   atmospheric window:
        ...
        [![Figure 1. Atmospheric Window](img/atmospheric%20window.png){width="633"}](https://gisgeography.com/atmospheric-window/)
...
However, what presented above is just one application in forest health monitoring, there has been a lot of other research focusing on different forest spectral indices according to different spatial and temporal scales[@lechner2020]. For instance, while UAV data can
capture millimeter-scale spatial-resolution data, the resulting remote-sensing images may contain tree branches, ground cover
through gaps in the canopies, individual leaves at different angles,
and shadows. But for many classification algorithm, it is better to not differentiate between individual elements of a tree.

![Figure 5. Spatial and temporal scales of ecological phenomenon](img/week1-scale.png)
